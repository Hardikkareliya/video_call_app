...
class _UserModel implements UserModel {
  const _UserModel({required this.id, this.email = '', @JsonKey(name: 'first_name') this.firstName = '', @JsonKey(name: 'last_name') this.lastName = '', this.avatar = ''});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Support&&(identical(other.url, url) || other.url == url)&&(identical(other.text, text) || other.text == text));
}
...
class _Support implements Support {
  const _Support({required this.url, required this.text});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Support&&(identical(other.url, url) || other.url == url)&&(identical(other.text, text) || other.text == text));
}
