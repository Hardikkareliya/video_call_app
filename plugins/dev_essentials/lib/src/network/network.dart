...
typedef DevEssentialNetworkResponseType = ResponseType;
...
typedef DevEssentialNetworkException = DioException;
typedef DefaultDevEssentialNetworkResponseTransformer = SyncTransformer;
