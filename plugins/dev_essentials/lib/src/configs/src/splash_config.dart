...
class SplashConfig {
  ...
  final SplashCallback? onSplashInitCallback;
  final SplashCallback? onSplashCloseCallback;
  final OnSplashCompleteCallback routeAfterSplash;
  ...
  SplashConfig copyWith({
    ...
    SplashCallback? onSplashInitCallback,
    SplashCallback? onSplashCloseCallback,
    OnSplashCompleteCallback? routeAfterSplash,
  }) =>
      SplashConfig(
        ...
        onSplashCloseCallback:
            onSplashCloseCallback ?? this.onSplashCloseCallback,
